		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item linkSize active" aria-current="page">
					<i class="fa fa-arrow-right" aria-hidden="true"></i> Category  List
				</li>
			</ol>
		</nav>
	</div>
	...
	<form method="post" action="<%=HTSView.CATEGORY_LIST_CTL%>">
		<div class="card">
			<h5 class="card-header"
				style="background-color: #00061df7; color: white;">Category List</h5>
			<div class="card-body">
				<div class="row g-3">
				...
				<table class="table table-bordered border-primary">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<%=HTSView.CATEGORY_CTL%>?id=<%=bean.getId()%>"><i
